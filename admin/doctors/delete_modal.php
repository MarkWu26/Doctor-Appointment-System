<div class="modal fade"  id="modalExport<?php echo $row['docid'];?>" tabindex="-1" aria-labelledby="modalExport" aria-hidden="true" data-bs-backdrop="true">
<form method="post">
            ...
            <div class="modal-content shadow-3">
                ...
                <div class="modal-body">
                    ...
                    <div class="d-flex align-items-center mb-5">
                        <div>
                            <input type="hidden" value="<?php echo $row['docid']; ?>" name="hidden"/>
                            <p class="text-sm" style="position: absolute; margin-left: 39px; margin-top: 7px;">

                                <span class="font-bold text-heading" style="font-size:16px; align-items:center;">Are you sure you want to delete doctor
                                <?php echo $row['fname'];?>  <?php echo $row['lname'];?>? </span>
                            </p>'

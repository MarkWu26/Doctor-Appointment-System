<div class="offcanvas offcanvas-end w-full w-lg-1/3" data-bs-scroll="true" data-bs-backdrop="true" tabindex="-1" id="offcanvasEdit<?php echo $row['docid'];?>" aria-labelledby="offcanvasCreateLabel">

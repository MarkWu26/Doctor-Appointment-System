            ...
            <div class="row align-items-center">
                <div class="col-sm col-12">
                    <h1 class="h2 ls-tight">
                        <span class="d-inline-block me-3">DOCTORS</span>
                    </h1>
                </div>
...
<div class="card">
    <div class="card-header border-bottom">
        ...
        $num_rows = mysqli_num_rows($squery);
         ...
         echo '<h5 class="mb-0"> All doctors  ('.$num_rows.') </h5> ';   
         ?>                                       
    </div>
    ...
    <div class="table-responsive">
        <table class="table table-hover table-nowrap" >
            ...
            <tbody>
                ...
                <?php
                $squery = mysqli_query($con, "SELECT *, CONCAT(fname, ' ' ,lname) as cname FROM doc ");
                ...
                <tr>
                    <td>
                    <img alt="..." src="./image/'.$row['image'].'" class="avatar avatar-sm rounded-circle me-2"> 
                    ...
                    <td>
                    <button class="btn btn-sm btn-square btn-neutral text-danger-hover"  data-bs-target="#offcanvasView'.$row['docid'].'" data-bs-toggle="offcanvas">
                    <i class="bi bi-eye">
                    </i>
                    </button>


                    <button class="btn btn-sm btn-square btn-neutral text-danger-hover" data-bs-target="#offcanvasEdit'.$row['docid'].'" data-bs-toggle="offcanvas">
                    ...
                    <button class="btn btn-sm btn-square btn-neutral text-danger-hover" data-bs-target="#modalExport'.$row['docid'].'" data-bs-toggle="modal">
                    <i class="bi bi-trash">
                    </i>
                    </button>

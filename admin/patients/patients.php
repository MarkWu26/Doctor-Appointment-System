                ...
                <div class="collapse navbar-collapse" id="sidebarCollapse">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item" >
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#sidebar-files">
                                                            ...
                                                            <div class="avatar avatar-sm bg-warning rounded-circle text-white">
                                                                ...
                                                                <div class="d-none d-sm-block ms-3">
                                                                    ...
                                                                    <span class="d-block text-heading font-semibold">'.$row['type'].'</span>';?>
                                                                     ...
                                                                     <a class="dropdown-item" href="../dashboard/dashboard.php"><i class="bi bi-house me-3"></i>Home </a>

<div class="dropdown-divider"></div><a class="dropdown-item" href="../../logout.php"><i class="bi bi-box-arrow-left me-3"></i>Logout</a></div>
</div>
</div>
</div>
</div>
            ...
            <div class="row align-items-center">
                <div class="col-sm col-12">
                    <h1 class="h2 ls-tight">
                        <span class="d-inline-block me-3">PATIENTS</span>
                    </h1>
                </div>

                <div class="col-sm-auto col-12 mt-4 mt-sm-0">
                    <div class="hstack gap-2 justify-content-sm-end">
                    <button data-bs-target="#offcanvasCreate" class="btn btn-sm btn-primary" data-bs-toggle="offcanvas">
                        <span class="pe-2">
...
<div class="card">
    <div class="card-header border-bottom">
        ...
        $num_rows = mysqli_num_rows($squery);
         ...
         echo '<h5 class="mb-0"> All Patients  ('.$num_rows.') </h5> ';   
         ?>                                       
    </div>
    ...
    <div class="table-responsive">
        <table class="table table-hover table-nowrap" >
            ...
            <tbody>
                ...
                $squery = mysqli_query($con, "SELECT *, CONCAT (fname, ' ' ,lname ) as cname FROM patient ");
                ...
                <tr>
                    ...
                    <a class="text-heading font-semibold" href="#">'.$row['cname'].'</a>
                    ...
                    '.$row['contactNumber'].'</span>
                    </td>
                   
                    <td>
                    <button class="btn btn-sm btn-square btn-neutral text-danger-hover" data-bs-target="#offcanvasView'.$row['id'].'" data-bs-toggle="offcanvas">
                    <i class="bi bi-eye">
                    </i>
                    </button>

                    <button class="btn btn-sm btn-square btn-neutral text-danger-hover" data-bs-target="#offcanvasEdit'.$row['id'].'" data-bs-toggle="offcanvas">
                    ...
                    <button class="btn btn-sm btn-square btn-neutral text-danger-hover" data-bs-target="#modalExport'.$row['id'].'" data-bs-toggle="modal">
                    <i class="bi bi-trash">
                    </i>
                    </button>

        ...
        <div class="offcanvas offcanvas-end w-full w-lg-1/3" data-bs-scroll="true" data-bs-backdrop="true" tabindex="-1" id="offcanvasCreate" aria-labelledby="offcanvasCreateLabel">
            ...
            <div class="offcanvas-body vstack gap-5">
                ...
                <div>
                       ...
                       <?php 
                       $query = mysqli_query($con, "SELECT *, CONCAT (fname, ' ' ,lname) as cname FROM patient");
                       ...
                       <?php 
                       $query = mysqli_query($con, "SELECT *, CONCAT(fname, ' ' ,lname) as cname FROM doc ");
                       while($row = mysqli_fetch_array($query)){
                        echo'
                        <option value="'.$row['docid'].'">'.$row['fname'].' '.$row['lname'].' </option>';
                       }
                       ?>

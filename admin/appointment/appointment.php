...
<div class="card">
    <div class="card-header border-bottom">
        <?php
        include ("../../connection.php");
        $squery = mysqli_query($con, "SELECT * FROM appointment");
        $num_rows = mysqli_num_rows($squery);

         echo '<h5 class="mb-0"> All Appointments  ('.$num_rows.') </h5> ';   
         ?>                                       
    </div>
    ...
    <div class="table-responsive">
        <table class="table table-hover table-nowrap" >
            ...
            <tbody>
                ...
                <?php
                $squery = mysqli_query($con, "SELECT *, CONCAT(p.fname, ' ' ,p.lname) as patientname, CONCAT(scheduleDate, ' ' ,scheduleTime) as DateTime, CONCAT(d.fname, ' ' , d.lname) as doctorname, a.patientid FROM appointment a left join patient p on p.id = a.patientid left join doc d on d.docid = a.doctorid");
                ...
                <tr>
                    ...
                    <a class="text-heading font-semibold" href="#">'.$row['appointmentid'].'</a>

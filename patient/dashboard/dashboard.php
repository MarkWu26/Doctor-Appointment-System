...
<div class="container-fluid">
        <div class="border-bottom pt-6">
            <div class="row align-items-center">
                <div class="col-sm col-12">
                    <?php 
                    echo'
                    <h1 class="h2 ls-tight"><span class="d-inline-block me-3">👋</span>Hi, Patient '.$_SESSION['fname'].' '.$_SESSION['lname'].' </h1>'
                    ?>
                </div>
    ...
    <div class="col-xl-3 col-sm-6 col-12">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col"><span class="h6 font-semibold text-muted text-sm d-block mb-2">Appointments Next Week</span>

                    <?php
                        include ("../../connection.php");
                        $nextweek = date('Y-m-d', strtotime("+1 week"));
                       
                         $squery = mysqli_query($con, "SELECT * FROM appointment where patientid = '".$_SESSION['userid']."' and  scheduleDate >= '$nextweek'");
                        $num_rows = mysqli_num_rows($squery);
    ...
    <div class="col-xl-3 col-sm-6 col-12">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col">
                        <span class="h6 font-semibold text-muted text-sm d-block mb-2">Sessions Next Month</span> 
                        <?php
                        $nxtmonth = date('Y-m-d', strtotime("+1 month"));
                        $appointment = mysqli_query($con, "SELECT * FROM appointment where patientid = '".$_SESSION['userid']."' and scheduleDate >= '$nxtmonth'  ");
        ...
        <div class="card">
            <div class="card-body">
                <div class="row">
                    ...
                    <?php 
                    $now = date('Y-m-d');
                    $query = mysqli_query($con, "SELECT * FROM appointment where scheduleDate = '$now' and patientid = '".$_SESSION['userid']."' ");

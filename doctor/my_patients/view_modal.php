<div class="offcanvas offcanvas-end w-full w-lg-1/3" data-bs-scroll="true" data-bs-backdrop="true" tabindex="-1" id="offcanvasView<?php echo $row['appointmentid'];?>" aria-labelledby="offcanvasCreateLabel">
        ...
        <div class="offcanvas-header border-bottom py-4 bg-surface-secondary">
            <h5 class="offcanvas-title" id="offcanvasCreateLabel">View Patient</h5>
    ...
    <div class="offcanvas-body vstack gap-5">
        ...
        <div class="col-md-6">
            ...
            while($viewrow = mysqli_fetch_array($aquery)){
                echo'
                <input type="text" class="form-control" name="title" value="'.$viewrow['patientfname'].'" readonly />';
            }
            ?>       
        </div>
        ...
        <div class="col-md-6">
            ...
            while($viewrow = mysqli_fetch_array($aquery)){
              echo'
              <input type="text" class="form-control" name="title" value="'.$viewrow['patientlname'].'" readonly />';
             }
             ?>
        </div>
        ...
        <div>
            ...
            while($viewrow = mysqli_fetch_array($aquery)){
                ...
                <input class="form-control" name="txt_bdate" type="date" value="'.$viewrow['birthDate'].'" placeholder="Birthdate" readonly>';
            }
            ?>
        </div>
        ...
        <?php
            ...
            <input class="form-control" name="txt_gender" value="'.$viewrow['gender'].'" readonly>';
            }
            ?>
        ...
        <?php
            ...
            while($viewrow = mysqli_fetch_array($aquery)){
                ...
                <input class="form-control" name="txt_mstatus" value="'.$viewrow['m_status'].'" readonly>';
            }
            ?>
        </div>
        ...
        <div>
            ...
            while($viewrow = mysqli_fetch_array($aquery)){
                ...
                <input type="text" class="form-control" name="number"" value="'.$viewrow['contactnumber'].'" readonly>';
            }
            ?>
        </div>
        ...
        <div>
            ...
            while($viewrow = mysqli_fetch_array($aquery)){
                ...
                <input type="text" class="form-control" name="txt_occupation" value="'.$viewrow['occupation'].'" readonly>';
            }
            ?>
        </div>
        ...
        <?php
            ...
            while($viewrow = mysqli_fetch_array($aquery)){
                ...
                <input type="text" class="form-control" name="txt_address" value="'.$viewrow['address'].'" readonly>';
            }
            ?>
        </div>
        ...
        <?php
            ...
            while($viewrow = mysqli_fetch_array($aquery)){
                ...
                <input type="text" class="form-control" name="txt_nationality" value="'.$viewrow['nationality'].'" readonly>';
            }
            ?>
        </div>

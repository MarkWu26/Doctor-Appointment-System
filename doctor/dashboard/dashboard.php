...
<div class="container-fluid">
            ...
            <div class="row align-items-center">
                <div class="col-sm col-12">
                    <h1 class="h2 ls-tight">
                        <?php
                        echo'
                        <span class="d-inline-block me-3">👋</span>Hi, Doctor '.$_SESSION['fname'].' '.$_SESSION['lname'].' </h1>'
                        ;?>
                </div>
        ...
        <div class="card">
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col">
                        <span class="h6 font-semibold text-muted text-sm d-block mb-2">My Appointments</span>
                        <?php
                        include ("../../connection.php");
                        $squery = mysqli_query($con, "SELECT * FROM appointment where doctorid = '".$_SESSION['userid']."' ");
    ...
    <div class="col-xl-3 col-sm-6 col-12">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col"><span class="h6 font-semibold text-muted text-sm d-block mb-2">My Patients</span>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col">
                        ...
                        <?php
                        $appointment = mysqli_query($con, "SELECT * FROM appointment where doctorid = '".$_SESSION['userid']."' ");
        ...
        <div class="card">
            <div class="card-body">
                <div class="row">
                    ...
                    <?php 
                    $now = date('Y-m-d');
                    $query = mysqli_query($con, "SELECT * FROM appointment where scheduleDate = '$now' and doctorid = '".$_SESSION['userid']."' ");

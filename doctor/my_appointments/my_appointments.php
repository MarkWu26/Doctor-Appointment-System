...
<div class="card">
    ...
    <div class="table-responsive">
        <table class="table table-hover table-nowrap" >
            ...
            <?php
                  $squery = mysqli_query($con, "SELECT *, CONCAT(p.fname, ' ' ,p.lname) as patientname, CONCAT(scheduleDate, ' ' ,scheduleTime) as DateTime, CONCAT(d.fname, ' ' , d.lname) as doctorname, a.patientid FROM appointment a left join patient p on p.id = a.patientid left join doc d on d.docid = a.doctorid where doctorid = '".$_SESSION['userid']."' ");
